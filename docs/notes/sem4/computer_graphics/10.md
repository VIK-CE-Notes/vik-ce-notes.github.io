...
virtuális valóság:
a számítógép ramjában élnek objektumok. "élnek"? hát van állapotuk, és ezt változtatja a többiek állapotai szerint. ha ezt mindenki csinálja, akkor mindenki néz mindenkit, és magától életre kel a rendszer. nekünk is meg kell jelennünk a virtuális világban, ez az "avatár", ő helyettesít minket. ő a szemünk, és őt vezéreljük, szemben a többi objektummal, amik magukról döntenek.

feladatok:
képszintézis az avatár nézőpontjából (1 szem, szereo, autosztereo) (lehetne VR-osan is pl, de ez egy bevezető kurzus)
avatárt vezéreljük (keyboard)
intelligens objektumok vezérlése (AI) (állapotgép)
a fizikai világot szimuláljuk (newtoni fizika)

OO.....
kinek milyen műveletek kellenek? hát minden objektum frissíti a saját állapotát, ez lehet a Control(). az új állapotba lépés az Animate() során történik meg (miért választjuk szét? a valós világ aszinkron, de a PC szekvenciális szimuláció (órajel) tehát csak egymás után tudja ezeket szimulálni, szóval ha lenne 100 objektumunk, és az egyik változna, akkor ő mindegyiknek a régi állapotát látná, de a második már az elsőnek az új állapotát, de a többinek a régit, stb stb. a valóság nem ilyen). utána a megjelenítése az új állapotnak a Draw(). az avatárnál továbbá kell a ProcessInput() hogy tudjuk irányítani, és meg kell mutatni a usernek h mi történik a világban (setCameraTransform)

volumetric shader:
ilyen "fuzzy" dolgok, nem definiálható éles határ, vagy olyan felület ami elválasztja az objektumot a környezetétől. tipikusan átlátszóak, a sűrűségük változó lehet. kicsi pamacsokból rakjuk össze. a pamacsok méretét, sűrűségét, színét változtathatjuk. a pamacs/flötyi geometriailag bonyinak tűnik, ezért azt a trükköt használjuk h nem foglalkozunk a geometriából, hanem fogjuk a flötyi képét, és azt odarakjuk. a textúrában teljesen átlátszó texelek is lehetnek. ezt a textúrát rárakjuk egy négyzetre, és ha a textúra határa átlátszó, akkor nem fog pontos határa lenni. ha más irányból is megnézzük, akkor picit gatya lehet a dolog, mert egy képről beszélünk. csaltunk, lebuktunk, de csalunk mégegyet. ha folyton a néző felé fordítjuk a téglalapot, akkor nem vékonyodik el oldalról.
