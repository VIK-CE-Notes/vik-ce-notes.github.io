<!-- NOTE: Ebben a fejezetben néhány helyen eléggé rossz a fogalmazás, és ráférne egy erős lektorálás/átfogalmazás -levy04 -->
...
![class diagram](./img/chapter_10/10_classdiagram.png){width=100%}
...
![volumetric](./img/chapter_10/10_volumetric.png){width=100%}
...
![átlátszóság](img/chapter_10/10_see_through.png){width=100%}
...
![frenet](./img/chapter_10/10_frenet_egye_meg.png){width=100%}
...
<!-- NOTE: Ez a rész nagyon hiányos, örülnék ha valamelyik hozzá értő kolléga kidolgozná -levy04 -->
