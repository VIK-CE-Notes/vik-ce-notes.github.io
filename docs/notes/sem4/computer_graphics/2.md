...
<!-- felhasználónak mutatunk egy virtuális világot, és tudja módosítani ezt, és ezeket a módosításokat lássa is. ez a kör a grafikus csővezeték

gpu csak pontokat, szakaszokat, és háromszögeket tud elfogadni. minden ezekkel van közelítve, csak aprólékosan
vektorizáció: görbéket meg stb-ket csinálunk ezekből.

esemény vezérelt programozás lesz -->
