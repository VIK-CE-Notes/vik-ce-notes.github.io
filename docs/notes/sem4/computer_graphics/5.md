...
??? tip Megoldás
    - A kamera középpontja a normalizált eszközkoordinátarendszerben: $(0, 0)$
...
??? tip Megoldás
    <!--Ha jól gondolom-->
    - A háromszög 3 oldalán lévő egyenesek meredekségét fogjuk osztással kiszámolni, azaz $3$ osztás történik
...
??? tip Megoldás
    Válasz: 0
    Magyarázat: Nem tudsz úgy berajzolni, hogy az ne az alakzaton kívül legyen.
...
??? tip Megoldás
    ...
    - [x] Van olyan több mint három csúcsú sokszög, amelynek nincs diagonálja.
        - Magyarázat: Kettővel fentebbi a példa alapján
    ...
    - [ ] A háromszögeket egy gráf csomópontjainak tekintve, a diagonálokat pedig a két oldalukon lévő háromszögeknek megfelelő csomópontok közötti élnek, a keletkező gráf tartalmazhat kört.
    - [ ] Minden több mint három csúcsú sokszögnek van legalább két füle.
        - Magyarázat: Nem, ha nem egyszerű
