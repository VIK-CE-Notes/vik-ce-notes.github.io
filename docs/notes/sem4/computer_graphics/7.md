...
- irányfényforrás *(directional light)*: egyetlen irányban párhuzamos fénysugarak, pozíciótol független intenzitás
...
> Az értelmezést az olvasóra bízzuk (lövésem sincs mi ez).
