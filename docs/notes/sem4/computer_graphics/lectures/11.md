<!-- NOTE: Ez a fejezet picit matekosabbra sikeredett, néhány helyen lehet, hogy rövidíteni kéne rajta, vagy legalább drop-down blokkba rakni pár részt, ami nem strictly releváns és a megértésben sem segít annyira. -levy04 -->
...
![belső szorzás](../img/chapter_11/11_mv_dot.png){width=100%}
...
??? failure "Ennek az állításnak a levezetése (:warning:KEEP OUT:warning:)"
    ...
    ![forgatás levezetés](../img/chapter_11/11_rotate_expl.png){width=100%}
    ...
    <!-- I love it when my KaTeX engine works properly, and I don't have to resort to HTML for simple commands! -->

    azaz $\displaystyle v'' = v * e^{\bm{I}2\varphi}$, tehát $v$-nek a $2\varphi$-vel elforgatott képe. <span style="display: flex; justify-content: flex-end;"> $\blacksquare$ </span>
...
![forgás tulajdonság](../img/chapter_11/11_non_commutative_rot.png){width=100%}
...
![rodriguez](../img/chapter_11/11_rodrigues.png){width=100%}
