...
Ezeket az objektumokat transzformálni szeretnénk (végső soron a képernyőkoordináta-rendszerbe), viszont beleütközünk a fentebb is említett problémába: pontokat könnyű transzformálni, de általános alakzatokat nem. Senki sem garantálja nekünk, hogy ami a transzformáció előtt egy kör volt, vagy egy háromszög volt, az utána is az lesz, pedig nekünk ez fontos lenne.
...
Itt a `wCenter` és `wSize` azok világkoordinátákban értelmezendők. Mivel sok koordináta-rendszeren átmegyünk a transzformációk során, ezért jó programozási gyakorlat, hogy a változók nevében valahogy jelezzük, hogy azokat éppen milyen koordináta-rendszerben kell értelmezni.
