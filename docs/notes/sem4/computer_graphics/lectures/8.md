...
???+ example Miért is kell az $N_\varepsilon$?
    ...
    <img src="../img/chapter_8/8_no_epsilon.png" alt="no_epsilon" style="margin: auto; width: 45%; display: block;"/>
...
Az osztálydiagramhoz magyarázatot [ebben](https://youtu.be/srjCb-wft4o&t=3400) a videóban lehet találni.
